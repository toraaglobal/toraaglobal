...
export const team: TeamMember[] = [
  {
    ...
    niche: 'Data Warehousing & Linux Systems',
    bio: 'With over 15 years of experience, Tajudeen architects scalable data infrastructures that form the bedrock of our clients\' success. His mastery of Linux environments ensures robust and secure systems.',
  },
  {
    image: PlaceHolderImages.find(p => p.id === 'ismail-akinwale')?.imageUrl || '',
    name: 'Dr. Ismail Akinwale',
    title: 'Head of AI Research',
    niche: 'Generative AI & LLMs',
    bio: 'Dr. Akinwale leads our research in Generative AI, pushing the boundaries of what\'s possible with Large Language Models. His work translates cutting-edge theory into practical business applications.',
  },
  {
    image: PlaceHolderImages.find(p => p.id === 'shereef-bankole')?.imageUrl || '',
    name: 'Dr. Shereef Bankole',
    title: 'Principal Data Scientist',
    niche: 'Predictive Analytics & ML',
    bio: 'Dr. Bankole specializes in creating predictive models that drive business outcomes. His expertise in machine learning helps clients anticipate trends and make data-informed decisions.',
  },
  {
    image: PlaceHolderImages.find(p => p.id === 'dayo-adebayo')?.imageUrl || '',
    name: 'Dayo Adebayo, PMP',
    title: 'Director of Project Management',
    niche: 'Agile Delivery & PMP',
    bio: 'As a certified PMP, Dayo ensures that every project is delivered on time and within scope. His focus on agile methodologies allows for flexibility and rapid value delivery to our clients.',
  },
  {
    image: PlaceHolderImages.find(p => p.id === 'dotun-oladele')?.imageUrl || '',
    name: 'Dotun Oladele',
    title: 'Senior Data Engineer',
    niche: 'ETL Pipelines & Cloud',
    bio: 'Dotun is an expert in building and optimizing complex ETL pipelines on major cloud platforms. He ensures that data flows seamlessly and reliably from source to insight.',
  },
];
